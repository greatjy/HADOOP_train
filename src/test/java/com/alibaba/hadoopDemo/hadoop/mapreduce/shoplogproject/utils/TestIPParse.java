package com.alibaba.hadoopDemo.hadoop.mapreduce.shoplogproject.utils;

import com.alibaba.hadoopdemo.hadoop.mapreduce.shoplogproject.utills.IPParser;
...
public class TestIPParse {
    ...
    @Test
    public void testIP() {
        IPParser.RegionInfo regionInfo = IPParser.getInstance().analyseIp("222.195.185.15");
